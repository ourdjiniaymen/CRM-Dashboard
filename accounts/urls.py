...
from .views import home_view, customer_view, products_view, create_order_view, update_order_view,delete_order_view, signup_view,login_view, logout_view
...
urlpatterns = [
    ...
    path('signup/', signup_view, name='signp'),
